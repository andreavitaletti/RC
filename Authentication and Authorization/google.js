...
app.get('/login', function(req, res){
  res.redirect("https://accounts.google.com/o/oauth2/v2/auth?scope=https://www.googleapis.com/auth/calendar&response_type=code&include_granted_scopes=true&state=state_parameter_passthrough_value&redirect_uri=http%3A%2F%2Flocalhost:3000&client_id=282543407998-28fl097ran4brmp4rb1o65p6kram4beb.apps.googleusercontent.com");
});
...
app.get('/', function(req, res){
  ...
  var formData = {
    ...
    client_secret: 'kRZzHX-U8CEYULLR3N0ynrJy',
